...
companyRouter.route('/createSubCategory').post((req, res) => new company_controller_1.CompanyController().createSubCategory(req, res));
companyRouter.route('/getMyCategories').post((req, res) => new company_controller_1.CompanyController().getMyCategories(req, res));
companyRouter.route('/getMySubCategories').post((req, res) => new company_controller_1.CompanyController().getMySubCategories(req, res));
...
companyRouter.route('/setItemSubCategory').post((req, res) => new company_controller_1.CompanyController().setItemSubCategory(req, res));
